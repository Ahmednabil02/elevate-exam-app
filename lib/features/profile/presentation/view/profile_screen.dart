                  ...
                  child: Column(
                    children: [
                      ProfileHeader(
                        ...
                        onImageEdit: () => context.read<ProfileCubit>().pickImage(),
                      ),
                      SizedBox(height: 32.h),
                      UserNameField(controller: _userNameController, enabled: true),
                      ...
                      SizedBox(height: 16.h),
                      PhoneField(controller: _phoneController, enabled: true),
